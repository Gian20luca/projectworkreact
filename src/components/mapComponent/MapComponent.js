        ...
        <div className="col-md-12">
          <HashRouter>
            ...
            {dbSoglie && <div className='divMaxLegend'>
                <div className='divLegendSmall'><small>Zona basso rischio {'0% - ' +dbSoglie[0].minThresholds + '%'}</small></div>
                <div className='divLegendSmall'><small>Zona medio rischio {dbSoglie[0].minThresholds + 1 + '% - ' + dbSoglie[0].maxThresholds + '%'}</small></div>
                <div className='divLegendSmall'><small>Zona alto rischio {dbSoglie[0].maxThresholds + 1 + '% -   100%' } </small></div>
              </div>}
              {dbSoglie && <div className='divMaxLegend'>
            ...
            {dbSoglie && <div className='divMaxLegend'>
                <div className='divLegendSmall'><small>Bassa densità decessi {'0% - ' +dbSoglie[1].minThresholds + '%'}</small></div>
                <div className='divLegendSmall'><small>Media densità decessi {dbSoglie[1].minThresholds + 1 + '% - ' + dbSoglie[1].maxThresholds + '%'}</small></div>
                <div className='divLegendSmall'><small>Alta densità decessi {dbSoglie[1].maxThresholds + 1 + '% -   100%' } </small></div>
              </div>}
              {dbSoglie && <div className='divMaxLegend'>
            ...
            {dbSoglie && <div className='divMaxLegend'>
                <div className='divLegendSmall'><small>Zona basso rischio {'0% - ' +dbSoglie[2].minThresholds + '%'}</small></div>
                <div className='divLegendSmall'><small>Zona medio rischio {dbSoglie[2].minThresholds + 1 + '% - ' + dbSoglie[2].maxThresholds + '%'}</small></div>
                <div className='divLegendSmall'><small>Zona alto rischio {dbSoglie[2].maxThresholds + 1 + '% -   100%' } </small></div>
              </div>}
              {dbSoglie && <div className='divMaxLegend'>
